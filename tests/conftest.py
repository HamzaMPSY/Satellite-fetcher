...
for directory in (
    ...
    TEST_DATA,
    TEST_MPL,
    TEST_NAPARI_CONFIG.parent,
):
    directory.mkdir(parents=True, exist_ok=True)

# Napari and other GUI/scientific dependencies try to write into user-scoped
# cache/config paths on import. Point them to a repo-local test runtime so the
# suite remains hermetic and works in sandboxed environments.
