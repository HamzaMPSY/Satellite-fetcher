...
from nimbuschain_mask_service.writer_support import storage_mode_from_metadata
...
def write_binary_mask_to_zarr(
    *,
    ...
    artifact_uri = str(metadata_record.artifact_uri or "").strip()
    status_path = str(metadata_record.status_path or "").strip()
    work_dir = str(metadata_record.work_dir or "").strip()
...
__all__ = ["write_binary_mask_to_zarr", "write_water_mask_tiles_to_zarr"]
